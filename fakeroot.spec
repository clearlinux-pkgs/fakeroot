...
Version  : 1.37.1.2
Release  : 14
URL      : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.37.1.2.orig.tar.gz
Source0  : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.37.1.2.orig.tar.gz
...
%prep
%setup -q -n fakeroot-1.37.1.2
cd %{_builddir}/fakeroot-1.37.1.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748535326
