...
Version  : 1.30.1
Release  : 12
URL      : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.30.1.orig.tar.gz
Source0  : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.30.1.orig.tar.gz
...
%prep
%setup -q -n fakeroot-1.30.1
cd %{_builddir}/fakeroot-1.30.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668103133
