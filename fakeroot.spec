...
Version  : 1.26
Release  : 8
URL      : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.26.orig.tar.gz
Source0  : https://mirrors.kernel.org/debian/pool/main/f/fakeroot/fakeroot_1.26.orig.tar.gz
...
%prep
%setup -q -n fakeroot-1.26
cd %{_builddir}/fakeroot-1.26
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631119638
...
cp %{_builddir}/fakeroot-1.26/COPYING %{buildroot}/usr/share/package-licenses/fakeroot/842745cb706f8f2126506f544492f7a80dbe29b3
%make_install
